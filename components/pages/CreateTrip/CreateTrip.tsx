...
import { HauntedCastleIcon, SkullIcon } from '../../halloween/HalloweenIcons';
...
const interestOptions = [
  ...
  { id: 'spooky', label: 'Haunted & Spooky', icon: HauntedCastleIcon, color: 'from-purple-600 via-red-600 to-orange-500', isSpooky: true },
];
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {interestOptions.map((option) => {
                  ...
                  const isSpookyOption = 'isSpooky' in option && option.isSpooky;
                  ...
                  return (
                    <motion.button
                      ...
                      className={`group relative overflow-hidden p-4 rounded-xl backdrop-blur-xl transition-all duration-300 ${
                        isSelected
                          ? isSpookyOption
                            ? 'bg-gradient-to-br from-purple-900/40 via-slate-900/60 to-orange-900/30 border-2 border-orange-500/60 shadow-[0_8px_32px_rgba(249,115,22,0.5),0_0_60px_rgba(147,51,234,0.3)]'
                            : 'bg-white/[0.08] border-2 border-teal-500/50 shadow-[0_8px_24px_rgba(20,184,166,0.3)]'
                          : isSpookyOption
                            ? 'bg-gradient-to-br from-purple-900/20 to-slate-900/40 border-2 border-purple-500/20 hover:border-orange-500/40 hover:shadow-[0_4px_20px_rgba(249,115,22,0.3)]'
                            : 'bg-white/[0.03] border-2 border-white/[0.05] hover:border-white/[0.12] hover:bg-white/[0.05] hover:shadow-lg'
                      }`}
                    >
                      {/* Premium Halloween Animation for Spooky Option */}
                      {isSpookyOption && (
                        <>
                          {/* Hover: Flying bats animation */}
                          <div className="absolute inset-0 overflow-hidden rounded-xl pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            {[0, 1].map((i) => (
                              <motion.div
                                ...
                                className="absolute text-purple-400/70 text-sm"
                              >
                                🦇
                              </motion.div>
                            ))}
                          ...
                          <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                            ...
                            >
                              <div className="w-1.5 h-1.5 rounded-full bg-red-500 shadow-[0_0_8px_#ef4444,0_0_16px_#ef4444]" />
                              <div className="w-1.5 h-1.5 rounded-full bg-red-500 shadow-[0_0_8px_#ef4444,0_0_16px_#ef4444]" />
                            </motion.div>
                          </div>

                          {/* Hover: Creeping mist from bottom */}
                          <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            className="absolute bottom-0 left-0 right-0 h-1/2 rounded-b-xl pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            style={{
                              background: 'linear-gradient(to top, rgba(147,51,234,0.4), rgba(147,51,234,0.1), transparent)',
                            }}
                          />
                          ...
                          <motion.div
                            animate={isSelected ? {
                              background: [
                                'linear-gradient(0deg, rgba(147,51,234,0.6), rgba(249,115,22,0.6), rgba(147,51,234,0.6))',
                                'linear-gradient(120deg, rgba(249,115,22,0.6), rgba(147,51,234,0.6), rgba(249,115,22,0.6))',
                                'linear-gradient(240deg, rgba(147,51,234,0.6), rgba(249,115,22,0.6), rgba(147,51,234,0.6))',
                                'linear-gradient(360deg, rgba(249,115,22,0.6), rgba(147,51,234,0.6), rgba(249,115,22,0.6))',
                              ],
                            } : {}}
                          ...
                          <motion.div
                            ...
                            style={{
                              background: 'linear-gradient(90deg, transparent, rgba(147,51,234,0.3), rgba(249,115,22,0.2), rgba(147,51,234,0.3), transparent)',
                          ...
                          {isSelected && [0, 1, 2].map((i) => (
                            <motion.div
                              key={`ghost-${i}`}
                              initial={{ opacity: 0, y: 20, x: 10 + i * 30 }}
                              animate={{
                                opacity: [0, 0.8, 0],
                                y: [20, -10, -30],
                                x: [10 + i * 30, 15 + i * 25, 20 + i * 20],
                              }}
                              transition={{
                                duration: 2.5,
                                repeat: Infinity,
                              ...
                              className="absolute bottom-2 text-white/60 pointer-events-none text-xs"
                            >
                              👻
                            </motion.div>
                          ))}
                          ...
                          {isSelected && [0, 1, 2, 3].map((i) => (
                            <motion.div
                              ...
                              style={{
                                background: i % 2 === 0 ? '#f97316' : '#a855f7',
                                boxShadow: i % 2 === 0 ? '0 0 8px #f97316' : '0 0 8px #a855f7',
                                top: `${15 + (i * 20)}%`,
                                right: `${10 + (i * 15)}%`,
                              }}
                            />
                          ...
                          <motion.div
                            ...
                            style={{
                              background: 'radial-gradient(ellipse at center, rgba(249,115,22,0.4) 0%, rgba(147,51,234,0.3) 50%, transparent 70%)',
                              filter: 'blur(12px)',
                            }}
                          />
                        </>
                      )}
                      {/* Premium glow for non-spooky options */}
                      {isSelected && !isSpookyOption && (
                        <motion.div
                          animate={{
                            opacity: [0.3, 0.6, 0.3],
                          }}
                      ...
                      <div className="flex items-center gap-3 relative z-10">
                        <motion.div
                          whileHover={{ scale: 1.1, rotate: isSpookyOption ? 0 : 5 }}
                          animate={isSpookyOption && isSelected ? {
                            y: [0, -3, 0],
                            rotate: [-2, 2, -2],
                          } : {}}
                          transition={isSpookyOption ? {
                            duration: 2,
                            repeat: Infinity,
                            ease: "easeInOut"
                          } : {}}
                          className={`w-10 h-10 backdrop-blur-lg bg-gradient-to-br ${option.color} rounded-lg flex items-center justify-center border shadow-lg ${
                            isSpookyOption 
                              ? isSelected 
                                ? 'border-orange-400/50 shadow-[0_0_20px_rgba(249,115,22,0.5)]' 
                                : 'border-purple-400/30 group-hover:border-orange-400/40 group-hover:shadow-[0_0_15px_rgba(249,115,22,0.3)]'
                              : 'border-white/[0.15]'
                          }`}
                        >
                          <motion.div
                          ...
                          >
                            <Icon className={`w-5 h-5 ${isSpookyOption && isSelected ? 'text-orange-200' : 'text-white'}`} />
                          </motion.div>
                        </motion.div>
                        <span className={`font-medium transition-colors ${
                          isSelected 
                            ? isSpookyOption 
                              ...
                              : 'text-white' 
                            : isSpookyOption 
                              ? 'text-purple-200/80 group-hover:text-orange-200' 
                              : 'text-white/70'
                        }`}>
                          {option.label}
                        </span>
                      ...
                      {isSelected && (
                        <motion.div
                          ...
                          className={`absolute top-2 right-2 rounded-full shadow-lg ${
                            isSpookyOption 
                              ? 'w-3 h-3 bg-gradient-to-br from-orange-400 to-purple-500 shadow-[0_0_12px_rgba(249,115,22,0.8)]' 
                              : 'w-2 h-2 bg-teal-400 shadow-teal-400/50'
                          }`}
                        />
                      )}
                    </motion.button>
        ...
        >
          ...
          >
            ...
            <span className="relative flex items-center justify-center gap-3">
              {isGenerating ? (
                <>
                  <HalloweenLoader variant="witch" size="sm" />
              ...
              {savedTripId ? (
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center gap-3">
                    {isSaving ? (
                      <>
                        <HalloweenLoader variant="pumpkin" size="sm" />
                        Saving...
                      </>
                    ) : (
                      <>
