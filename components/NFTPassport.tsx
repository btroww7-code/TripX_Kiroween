...
import { HalloweenPassportOverlay } from './halloween/HalloweenPassportOverlay';
...
interface NFTPassportProps {
  ...
  totalXP: number;
  enableHalloweenOverlay?: boolean;
}
...
export const NFTPassport: React.FC<NFTPassportProps> = ({ tier, level, questsCompleted, totalXP, enableHalloweenOverlay = true }) => {
  ...
  return (
    ...
    >
      <div className="relative backdrop-blur-xl bg-gradient-to-br from-slate-800/90 to-slate-900/90 rounded-3xl p-8 border border-slate-700/50 shadow-2xl overflow-hidden">
        {/* Halloween Overlay */}
        {enableHalloweenOverlay && <HalloweenPassportOverlay />}
